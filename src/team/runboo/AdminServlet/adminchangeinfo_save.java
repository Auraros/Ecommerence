package team.runboo.AdminServlet;
...
@WebServlet("/adminchangeinfo_save ")
public class adminchangeinfo_save  extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request,
		...
		String head_portraits = request.getParameter("head_portraits");
		...
		result = register_C.update_admin_imformation(nickname,sex, phone_number, id_card, password, birthday, address, real_name,  email,  head_portraits);
