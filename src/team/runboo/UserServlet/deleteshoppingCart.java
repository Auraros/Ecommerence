...
public class deleteshoppingCart extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request,
		...
		//得到每个参数的值
		String books_id = request.getParameter("SC_book_id");
		...
		databasefuntion2 deleteusercart_C2 = new databasefuntion2();
		String result = deleteusercart_C2.delete_cart(phone_number, books_id);
